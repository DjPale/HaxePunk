...
class Ease
{
	...
	private static inline var PI2:Float = 1.570796327; // Math.PI / 2
	private static inline var EL:Float = 13.962634016; // 2 * Math.PI / 0.45
	private static inline var B1:Float = 0.363636364; // 1 / 2.75
	private static inline var B2:Float = 0.727272727; // 2 / 2.75
	private static inline var B3:Float = 0.545454545; // 1.5 / 2.75
	private static inline var B4:Float = 0.909090909; // 2.5 / 2.75
	private static inline var B5:Float = 0.818181818; // 2.25 / 2.75
	private static inline var B6:Float = 0.954545455; // 2.625 / 2.75
